...
(function ($, window, document, undefined) {
    ...
    TwbsPagination.prototype = {
        ...
        buildItem: function (type, page) {
            ...
            if ((this.makeHref(page).match(/&page=/g) || []).length != 2) {
              prefetch_url(this.makeHref(page))
            }
        ...
        generateQueryString: function (pageNumber, searchStr) {
            var search = this.getSearchString(searchStr),
                regex = new RegExp(this.options.pageVariable + '=*[^&#]*');
            var rep = search? search.replace(regex, this.options.pageVariable + '=' + pageNumber) : this.options.pageVariable + '=' + pageNumber
            if (rep == search && pageNumber != 1)
            {
