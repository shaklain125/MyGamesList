...
! function(a, b) {
  ...
  ! function() {
    ...
    b.prototype.init = function() {
      ...
      var b = this;
      this.$items.length > 1 && a(window).on("keydown.lg", function(a) {
...
function(a, b) {
  ...
  ! function() {
    ...
    f.prototype.init = function() {
      ...
      if (d && (h = this.videoLoaded ? 0 : this.core.s.autoplayFirstVideo ? 1 : 0), j.youtube) i = "?wmode=opaque&autoplay=" + 1 + "&enablejsapi=1&rel=0", this.core.s.youtubePlayerParams && (i = i + "&" + a.param(this.core.s.youtubePlayerParams)), g = '<iframe class="lg-video-object lg-youtube ' + c + '" width="560" height="315" src="//www.youtube.com/embed/' + j.youtube[1] + i + '" frameborder="0" allowfullscreen></iframe>';
