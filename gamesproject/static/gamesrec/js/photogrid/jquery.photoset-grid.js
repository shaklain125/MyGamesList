      ...
      _setupColumns: function(  elem, options ){
        ...
        var setupStyles = function(waitForImagesLoaded){
          ...
          if(options.highresLinks){
            ...
            $images.each(function(){
              var link = function () {
                return `<a href="${$(this).attr('data-href')}"></a>`
              }
              if(options.borderActive){
                $(this).wrapAll(link).wrapAll('<div class="photoset-cell photoset-cell--border" />');
                $(this).wrapAll(link).wrapAll('<div class="photoset-content-border" />');
              } else {
                $(this).wrapAll(link).wrapAll('<div class="photoset-cell" />');
              }
            });
          }
          ...
          $(elem).find('a:not(:last-child)').find('.photoset-cell').css({
            'padding-right': (gutterVal / 2) + 'px'
          });
          $(elem).find('a:not(:first-child)').find('.photoset-cell').css({
